...
from schedules.api.views import ScheduleListAPIView, ScheduleCreateUpdateAPIView, WorkShiftListAPIView, WorkShiftCreateUpdateAPIView, ScheduleSettingListAPIView, ScheduleSettingCreateUpdateAPIView
...
urlpatterns = [
  ...
  path('delete/<id>/', ScheduleCreateUpdateAPIView.as_view(), name='schedule-update'),
]