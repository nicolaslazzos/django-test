...
urlpatterns = [
  ...
  path('payment/create/', PaymentCreateUpdateAPIView.as_view(), name='payment-create'),
  path('payment/update/<id>/', PaymentCreateUpdateAPIView.as_view(), name='payment-update'),
